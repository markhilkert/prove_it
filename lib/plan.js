...
When all implementation and testing above is finished, ask the user whether
to run \`prove_it signal done\`, which starts prove_it's quality gates (test
suites, code review agents). Run it once they say so. If a reviewer fails,
report the findings and wait for their direction.
